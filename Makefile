...
# Template: app
# Command: C:\Qt\5.7\mingw53_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile Game\Game.pro
#############################################################################
...
Makefile: Game/Game.pro ../../../../Qt/5.7/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile Game\Game.pro
